...
class DifferentiatedTest {
    ...
    void setUp() {
        ...
        double rate = 10;
        int period = 10;
        credit = new Differentiated(sum, period, rate);
    }
    ...
    void monthlyPayment() {
        BigDecimal expected = BigDecimal.valueOf(11_000.00);
    ...
    void generalSum() {
        BigDecimal expected = BigDecimal.valueOf(110_000.00);
